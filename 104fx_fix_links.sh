...
install_name_tool -change /opt/local/lib/gcc46/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/local/lib/gcc46/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib browser/components/libbrowsercomps.dylib
...
install_name_tool -change /opt/local/lib/gcc46/libstdc++.6.dylib @executable_path/libstdc++.6.dylib -change /opt/local/lib/gcc46/libgcc_s.1.dylib @executable_path/libgcc_s.1.dylib webapprt-stub
