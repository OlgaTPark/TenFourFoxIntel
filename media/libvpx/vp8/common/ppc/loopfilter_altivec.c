...
void loop_filter_bhs_ppc(unsigned char *y_ptr, int y_stride, const unsigned char *blimit)
{
...
void loop_filter_bvs_ppc(unsigned char *y_ptr, int y_stride, const unsigned char *blimit)
{
...
void loop_filter_mbhs_ppc(unsigned char *y_ptr, int y_stride, const unsigned char *blimit)
{
    loop_filter_simple_horizontal_edge_ppc(y_ptr, y_stride, blimit);
}

void loop_filter_mbvs_ppc(unsigned char *y_ptr, int y_stride, const unsigned char *blimit)
{
