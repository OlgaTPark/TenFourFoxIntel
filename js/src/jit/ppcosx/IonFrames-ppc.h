...
#ifndef jsion_ionframes_ppc_h__
#define jsion_ionframes_ppc_h__
...
// This is the frame used entering Ion code from ABI-compliant code.
// This is NOT an ABI stack frame.
// This is NOT the same as x86 (we track ARM here).
...
class IonUnwoundRectifierFrameLayout : public IonRectifierFrameLayout
{
  public:
    static inline size_t Size() {
        // X86 used to have an extra callee token here, but we don't.
...
// ABI compliant code. Again, this is NOT an ABI stack frame.
class IonExitFrameLayout : public IonCommonFrameLayout
{
  ...
  public:
    ...
    // each wrapper are pushed before the exit frame. These correspond exactly
