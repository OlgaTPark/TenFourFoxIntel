...
// Each entry in the bailout table is a full call stanza.
static const uint32_t BAILOUT_TABLE_ENTRY_SIZE    = PPC_CALL_STANZA_LENGTH;
...
class Registers
{
  public:
    ...
    /* Although r0, r1, r2, r11 and r12 are technically volatile, don't
       declare them here, or Ion will try to use them! */
...
/*
    ...
    // Firefox 26+ now enforces a maximum of 27 registers; see Snapshots.cpp.
